	...
	<head>
		...
		<style>
			...
			*,*::before,*::after{box-sizing:border-box}
			...
			/* Footer — Medios de pago en fila horizontal */
			.js-footer span:has(.icon-logo) {
				display: flex !important;
			...
			/* Categorías — centrado con espaciado vertical simétrico */
			.section-categories-home .d-flex {
				justify-content: center !important;
